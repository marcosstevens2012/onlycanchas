...
class TurnoPadleController extends Controller
{
    //constructor
    ...
    public function index(Request $request){
        ...
        ->join('persona', 'persona.id', '=', 'turno.id')
        ->join('cancha','cancha.id','=','turno.id')
        ->join('estado_turno','estado_turno.id','=','turno.id')
        ->select('turno.*','persona.*','cancha.*','estado_turno.estado as estadot', DB::raw('CONCAT(persona.nombre, " ",persona.apellido) AS cliente'))
        ...
        $data = DB::table('turno')
        ->join('persona', 'persona.id', '=', 'turno.idcliente')
        ->join('cancha','cancha.id','=','turno.idcancha')
        ->join('estado_turno','estado_turno.id','=','turno.idestado')
        ->select('turno.*','persona.*','cancha.*','estado_turno.estado as estadot',DB::raw('CONCAT(persona.nombre, " ",persona.apellido) AS cliente'))
        ->orderBy('turno.created_at', 'desc')
        ->get();
        ...
        return view('turno.index',compact('turnos','clientes','canchas','horarios','fechamax','estados'));
    }
    public function create()
    {
        ...
        $clientes = Persona::all();
        $canchas = Cancha::all();
        return view("turno.create", compact('clientes','canchas'));
    }
